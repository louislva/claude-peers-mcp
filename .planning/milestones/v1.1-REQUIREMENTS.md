...
- [x] **CMD-02**: /comms-peers prints inline formatted peer list (no TUI, no tmux required)
- [x] **CMD-03**: /comms-send <peer-id> <message> sends message to peer and reports success/failure inline
- [x] **CMD-04**: /comms-stats prints inline stats dump with row counts and retention policy
