---
name: comms-send
description: "Send a message to a gsd-comms instance"
allowed-tools: Bash
---

Send a message to a specific gsd-comms instance. This command requires two arguments: a peer ID and a message text.
...
Run: `curl -s --max-time 3 -X POST -H 'Content-Type: application/json' -d '<json-body>' http://127.0.0.1:${GSD_COMMS_PORT:-${CLAUDE_PEERS_PORT:-7899}}/send-message`
