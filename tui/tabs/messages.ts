/**
 * tui/tabs/messages.ts — Messages placeholder tab
 *
 * Renders a placeholder for the message feed from broker /list-messages.
...
export function render(
  ...
  const label = "Messages - broker /list-messages";
  const note = "(Phase 8)";
