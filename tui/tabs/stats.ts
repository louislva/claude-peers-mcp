/**
 * tui/tabs/stats.ts — Stats placeholder tab
 *
 * Renders a placeholder for the DB stats from broker /stats + /health.
 * Polls less frequently (5s) than other broker tabs.
...
export function render(
  ...
  const label = "Stats - broker /stats + /health";
  const note = "(Phase 8)";
