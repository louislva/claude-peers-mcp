/**
 * tui/tabs/gsd-watch.ts — GSD Watch placeholder tab
 *
 * Renders a placeholder for the .planning/ tree view.
 * Real implementation in Phase 7 (fs.watch-driven, no polling).
 */

import { moveTo, write, fg, resetStyle, C, getTermSize } from "../render.ts";

export const TAB_NAME = "GSD Watch";
export const REFRESH_MS = 0; // event-driven via fs.watch in Phase 7
...
export function render(
  ...
  const label = "GSD Watch - .planning/ tree view";
  const note = "(Phase 7)";
